...
use crate::bitcoin_encoding::{encode_varint, parse_u32_be_hex};
...
pub fn validate_share(
    ...
    let en2 =
        hex::decode(submit.extranonce2.trim_start_matches("0x")).context("decode extranonce2")?;
...
fn parse_u32_be(s: &str) -> anyhow::Result<u32> {
    parse_u32_be_hex(s).ok_or_else(|| anyhow!("invalid u32 hex"))
}
